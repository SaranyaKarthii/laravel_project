    ...
    e(function () {
        e("#contact_form").validator(), e("#contact_form").on("submit", function (a) {
            if (!a.isDefaultPrevented()) {
                ...
                return e.ajax({
                    type: "POST", url: t, data: e(this).serialize(), success: function (a) {
                        var t = "alert-" + a.type, o = a.message,
        ...
        e("body").on("mousemove", function (a) {
            var t = a.pageX - e(document).width() / 2, o = a.pageY - e(document).height() / 2, s = n * t * -1,
                m = i * o * -1, c = e(".lm-animated-bg");
            c.addClass("transition"), c.css({"background-position": "calc( 50% + " + s + "px ) calc( 50% + " + m + "px )"}), setTimeout(function () {
        ...
        if (m.imagesLoaded(function () {
            ...
            var a = e(".blog-filters"), t = a.find("a.filter");
            t.click(function () {
                var a = e(this);
            ...
            var c = "San Francisco, S601 Townsend Street, California, USA", c = encodeURIComponent(c),
